...
import { terms } from "@/constants/conditions";
        ...
        <div className="flex flex-col md:flex-row md:gap-4 xl:gap-16">
          ...
          <div className="md:w-3/4">
            ...
            <span className="font-normal text-xs">
              Data de entrada em vigor: 00/00/0000
            </span>
            <p className="font-normal text-xs mb-6">
              Bem-vindo ao website da GUAPI PAPÉIS®. Ao acessar e utilizar
              nossos serviços, você concorda com os seguintes Termos de Uso.
              Leia atentamente este documento antes de continuar sua navegação.
            </p>
            ...
            <div ref={contentRef}>
              {filteredTerms.map((term, index) => (
                ...
                >
                  <div className=" pt-4">
                    <TitleList title={term.title} text={term.text} />
                  </div>
                </div>
              ))}
            </div>
